...
import useChzzkLiveChat, { ChzzkLiveChatHealth } from '../../../chzzk/useChzzkLiveChat';
...
export default function ChzzkCollector({ channelId }: { channelId: string }) {
  ...
  useChzzkLiveChat(runtimeConfig == null ? undefined : channelId, handleChat, {
  ...
  return (
    <main className="collector-shell">
      <section className="collector-status" aria-live="polite">
        <h1>UNDERCOVER CHZZK Collector</h1>
        <dl>
          <dt>Bootstrap</dt>
